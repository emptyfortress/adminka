...
function __VLS_template() {
    ...
    __VLS_intrinsicElements.p;
    {
        ...
        const __VLS_1 = __VLS_asFunctionalComponent(__VLS_0, new __VLS_0({ ...{}, behavior: ("desktop"), modelValue: ((props.show)), side: ("right"), bordered: (true), width: ((256)), }));
        ({}.QDrawer);
        const __VLS_2 = __VLS_1({ ...{}, behavior: ("desktop"), modelValue: ((props.show)), side: ("right"), bordered: (true), width: ((256)), }, ...__VLS_functionalComponentArgsRest(__VLS_1));
        ({}({ ...{}, behavior: ("desktop"), modelValue: ((props.show)), side: ("right"), bordered: (true), width: ((256)), }));
        {
...
//# sourceMappingURL=RDrawer.vue.js.map