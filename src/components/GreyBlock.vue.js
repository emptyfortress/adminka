    ...
    [QCardActions,];
    {
        ...
        ({}({ ...{}, }));
        {
            ...
            }
            {
                ...
                {
                    const __VLS_87 = {}.QSelect;
                    const __VLS_88 = __VLS_asFunctionalComponent(__VLS_87, new __VLS_87({ ...{}, class: (" rem"), modelValue: ((__VLS_ctx.form.servertype)), dense: (true), outlined: (true), options: ((__VLS_ctx.options)), bgColor: ("white"), }));
                    ({}.QSelect);
                    const __VLS_89 = __VLS_88({ ...{}, class: (" rem"), modelValue: ((__VLS_ctx.form.servertype)), dense: (true), outlined: (true), options: ((__VLS_ctx.options)), bgColor: ("white"), }, ...__VLS_functionalComponentArgsRest(__VLS_88));
                    ({}({ ...{}, class: (" rem"), modelValue: ((__VLS_ctx.form.servertype)), dense: (true), outlined: (true), options: ((__VLS_ctx.options)), bgColor: ("white"), }));
                ...
                }
                {
                    ...
                    const __VLS_98 = __VLS_asFunctionalComponent(__VLS_97, new __VLS_97({ ...{}, modelValue: ((__VLS_ctx.form.email)), dense: (true), outlined: (true), bgColor: ("white"), }));
                    ({}.QInput);
                    const __VLS_99 = __VLS_98({ ...{}, modelValue: ((__VLS_ctx.form.email)), dense: (true), outlined: (true), bgColor: ("white"), }, ...__VLS_functionalComponentArgsRest(__VLS_98));
                    ({}({ ...{}, modelValue: ((__VLS_ctx.form.email)), dense: (true), outlined: (true), bgColor: ("white"), }));
            ...
            }
            {
                ...
                const __VLS_104 = __VLS_103({ ...{}, class: (" border"), }, ...__VLS_functionalComponentArgsRest(__VLS_103));
                ({}({ ...{}, class: (" border"), }));
                {
                    const __VLS_107 = __VLS_intrinsicElements["div"];
                    const __VLS_108 = __VLS_elementAsFunctionalComponent(__VLS_107);
                    const __VLS_109 = __VLS_108({ ...{}, class: (" form"), }, ...__VLS_functionalComponentArgsRest(__VLS_108));
                    ({}({ ...{}, class: (" form"), }));
                    {
                    ...
                    }
                    {
                        ...
                        const __VLS_118 = __VLS_asFunctionalComponent(__VLS_117, new __VLS_117({ ...{}, modelValue: ((__VLS_ctx.form.server)), dense: (true), outlined: (true), bgColor: ("white"), }));
                        ({}.QInput);
                        const __VLS_119 = __VLS_118({ ...{}, modelValue: ((__VLS_ctx.form.server)), dense: (true), outlined: (true), bgColor: ("white"), }, ...__VLS_functionalComponentArgsRest(__VLS_118));
                        ({}({ ...{}, modelValue: ((__VLS_ctx.form.server)), dense: (true), outlined: (true), bgColor: ("white"), }));
                    ...
                    }
                    {
                        ...
                        const __VLS_128 = __VLS_asFunctionalComponent(__VLS_127, new __VLS_127({ ...{}, modelValue: ((__VLS_ctx.form.version)), dense: (true), outlined: (true), bgColor: ("white"), }));
                        ({}.QInput);
                        const __VLS_129 = __VLS_128({ ...{}, modelValue: ((__VLS_ctx.form.version)), dense: (true), outlined: (true), bgColor: ("white"), }, ...__VLS_functionalComponentArgsRest(__VLS_128));
                        ({}({ ...{}, modelValue: ((__VLS_ctx.form.version)), dense: (true), outlined: (true), bgColor: ("white"), }));
                    ...
                    {
                        const __VLS_137 = {}.QInput;
                        const __VLS_138 = __VLS_asFunctionalComponent(__VLS_137, new __VLS_137({ ...{}, modelValue: ((__VLS_ctx.form.auth)), dense: (true), outlined: (true), bgColor: ("white"), }));
                        ({}.QInput);
                        const __VLS_139 = __VLS_138({ ...{}, modelValue: ((__VLS_ctx.form.auth)), dense: (true), outlined: (true), bgColor: ("white"), }, ...__VLS_functionalComponentArgsRest(__VLS_138));
                        ({}({ ...{}, modelValue: ((__VLS_ctx.form.auth)), dense: (true), outlined: (true), bgColor: ("white"), }));
                    ...
                    }
                    {
                        ...
                        const __VLS_144 = __VLS_143({ ...{}, class: (" label"), }, ...__VLS_functionalComponentArgsRest(__VLS_143));
                        ({}({ ...{}, class: (" label"), }));
                    ...
                    }
                    {
                        ...
                        const __VLS_148 = __VLS_asFunctionalComponent(__VLS_147, new __VLS_147({ ...{}, modelValue: ((__VLS_ctx.form.login)), dense: (true), outlined: (true), bgColor: ("white"), }));
                        ({}.QInput);
                        const __VLS_149 = __VLS_148({ ...{}, modelValue: ((__VLS_ctx.form.login)), dense: (true), outlined: (true), bgColor: ("white"), }, ...__VLS_functionalComponentArgsRest(__VLS_148));
                    ...
                    }
                    {
                        ...
                        const __VLS_154 = __VLS_153({ ...{}, class: (" label"), }, ...__VLS_functionalComponentArgsRest(__VLS_153));
                        ({}({ ...{}, class: (" label"), }));
                        (__VLS_155.slots).default;
                        const __VLS_155 = __VLS_pickFunctionalComponentCtx(__VLS_152, __VLS_154);
                    }
                    {
                        const __VLS_157 = {}.QInput;
                        const __VLS_158 = __VLS_asFunctionalComponent(__VLS_157, new __VLS_157({ ...{}, modelValue: ((__VLS_ctx.form.password)), dense: (true), outlined: (true), bgColor: ("white"), type: ("password"), }));
                        ({}.QInput);
                        const __VLS_159 = __VLS_158({ ...{}, modelValue: ((__VLS_ctx.form.password)), dense: (true), outlined: (true), bgColor: ("white"), type: ("password"), }, ...__VLS_functionalComponentArgsRest(__VLS_158));
            ...
            }
            {
                ...
                const __VLS_164 = __VLS_163({ ...{}, class: (" form"), }, ...__VLS_functionalComponentArgsRest(__VLS_163));
                ({}({ ...{}, class: (" form"), }));
                {
                    const __VLS_167 = __VLS_intrinsicElements["div"];
                ...
                {
                    const __VLS_172 = {}.QCheckbox;
                    const __VLS_173 = __VLS_asFunctionalComponent(__VLS_172, new __VLS_172({ ...{}, modelValue: ((__VLS_ctx.form.def1)), dense: (true), label: ("Использовать по умолчанию"), }));
                    ({}.QCheckbox);
                    const __VLS_174 = __VLS_173({ ...{}, modelValue: ((__VLS_ctx.form.def1)), dense: (true), label: ("Использовать по умолчанию"), }, ...__VLS_functionalComponentArgsRest(__VLS_173));
            ...
            if (__VLS_ctx.editMode1) {
                {
                    const __VLS_177 = {}.QCardActions;
                    const __VLS_178 = __VLS_asFunctionalComponent(__VLS_177, new __VLS_177({ ...{}, align: ("right"), }));
                    ({}.QCardActions);
                    const __VLS_179 = __VLS_178({ ...{}, align: ("right"), }, ...__VLS_functionalComponentArgsRest(__VLS_178));
                    ({}({ ...{}, align: ("right"), }));
                    {
                        const __VLS_182 = {}.QBtn;
                        const __VLS_183 = __VLS_asFunctionalComponent(__VLS_182, new __VLS_182({ ...{ 'onClick': {}, }, flat: (true), label: ("Отмена"), }));
                        ({}.QBtn);
                        const __VLS_184 = __VLS_183({ ...{ 'onClick': {}, }, flat: (true), label: ("Отмена"), }, ...__VLS_functionalComponentArgsRest(__VLS_183));
                        ({}({ ...{ 'onClick': {}, }, flat: (true), label: ("Отмена"), }));
                        let __VLS_187 = { 'click': __VLS_pickEvent(__VLS_186['click'], {}.onClick) };
                        __VLS_187 = { click: $event => {
                                if (!((__VLS_ctx.editMode1)))
                                    return;
                                __VLS_ctx.editMode1 = false;
                                // @ts-ignore
                                [name, form, form, form, form, options, form, options, form, options, form, form, form, form, form, form, form, form, form, form, form, form, form, form, form, form, form, form, form, form, form, editMode1, editMode1,];
                            }
                        };
                    ...
                    }
                    {
                        ...
                        const __VLS_189 = __VLS_asFunctionalComponent(__VLS_188, new __VLS_188({ ...{ 'onClick': {}, }, unelevated: (true), color: ("primary"), label: ("Сохранить"), }));
                        ({}.QBtn);
                        const __VLS_190 = __VLS_189({ ...{ 'onClick': {}, }, unelevated: (true), color: ("primary"), label: ("Сохранить"), }, ...__VLS_functionalComponentArgsRest(__VLS_189));
                        ({}({ ...{ 'onClick': {}, }, unelevated: (true), color: ("primary"), label: ("Сохранить"), }));
                        let __VLS_193 = { 'click': __VLS_pickEvent(__VLS_192['click'], {}.onClick) };
                        __VLS_193 = { click: (__VLS_ctx.save1) };
...
//# sourceMappingURL=GreyBlock.vue.js.map