...
function __VLS_template() {
    ...
    __VLS_components.qStep;
    // @ts-ignore
    [QStep, QStep, QStep, QStep, QStep, QStep, QStep,];
    {
        ...
        ({}({ ...{}, class: (" create"), }));
        {
                ...
                ({}({ ...{}, name: ((1)), prefix: ("1"), title: ("Сервер SQL"), done: ((__VLS_ctx.step > 1)), }));
                {
                    ...
                    ({}({ ...{}, class: (" all900"), }));
                    {
                        ...
                        ({}({ ...{}, class: (" arch"), }));
                        {
                            ...
                            const __VLS_26 = __VLS_asFunctionalComponent(__VLS_25, new __VLS_25({ ...{}, is: ((__VLS_ctx.Step1)), ref: ("st1"), }));
                            const __VLS_27 = __VLS_26({ ...{}, is: ((__VLS_ctx.Step1)), ref: ("st1"), }, ...__VLS_functionalComponentArgsRest(__VLS_26));
                            ({}({ ...{}, is: ((__VLS_ctx.Step1)), ref: ("st1"), }));
                            // @ts-ignore
                            (__VLS_ctx.st1);
            ...
            }
            {
                ...
                const __VLS_31 = __VLS_asFunctionalComponent(__VLS_30, new __VLS_30({ ...{}, name: ((2)), prefix: ("2"), title: ("Скрипт создания"), done: ((__VLS_ctx.step > 2)), }));
                ({}.QStep);
                const __VLS_32 = __VLS_31({ ...{}, name: ((2)), prefix: ("2"), title: ("Скрипт создания"), done: ((__VLS_ctx.step > 2)), }, ...__VLS_functionalComponentArgsRest(__VLS_31));
                ({}({ ...{}, name: ((2)), prefix: ("2"), title: ("Скрипт создания"), done: ((__VLS_ctx.step > 2)), }));
                {
                    ...
                    ({}({ ...{}, class: (" all900"), }));
                    {
                        ...
                        ({}({ ...{}, class: (" arch"), }));
                        {
                            const __VLS_45 = (__VLS_ctx.Step2);
                            const __VLS_46 = __VLS_asFunctionalComponent(__VLS_45, new __VLS_45({ ...{}, is: ((__VLS_ctx.Step2)), }));
                            const __VLS_47 = __VLS_46({ ...{}, is: ((__VLS_ctx.Step2)), }, ...__VLS_functionalComponentArgsRest(__VLS_46));
                            ({}({ ...{}, is: ((__VLS_ctx.Step2)), }));
            ...
            {
                const __VLS_50 = {}.QStep;
                const __VLS_51 = __VLS_asFunctionalComponent(__VLS_50, new __VLS_50({ ...{}, name: ((3)), prefix: ("3"), title: ("База данных"), done: ((__VLS_ctx.step > 3)), }));
                ({}.QStep);
                const __VLS_52 = __VLS_51({ ...{}, name: ((3)), prefix: ("3"), title: ("База данных"), done: ((__VLS_ctx.step > 3)), }, ...__VLS_functionalComponentArgsRest(__VLS_51));
                ({}({ ...{}, name: ((3)), prefix: ("3"), title: ("База данных"), done: ((__VLS_ctx.step > 3)), }));
                {
                    const __VLS_55 = __VLS_intrinsicElements["div"];
                    const __VLS_56 = __VLS_elementAsFunctionalComponent(__VLS_55);
                    const __VLS_57 = __VLS_56({ ...{}, class: (" all900"), }, ...__VLS_functionalComponentArgsRest(__VLS_56));
                    ({}({ ...{}, class: (" all900"), }));
                    {
                        const __VLS_60 = __VLS_intrinsicElements["div"];
                        const __VLS_61 = __VLS_elementAsFunctionalComponent(__VLS_60);
                        const __VLS_62 = __VLS_61({ ...{}, class: (" arch"), }, ...__VLS_functionalComponentArgsRest(__VLS_61));
                        ({}({ ...{}, class: (" arch"), }));
                        {
                            const __VLS_65 = (__VLS_ctx.Step3);
                            const __VLS_66 = __VLS_asFunctionalComponent(__VLS_65, new __VLS_65({ ...{}, is: ((__VLS_ctx.Step3)), }));
                            const __VLS_67 = __VLS_66({ ...{}, is: ((__VLS_ctx.Step3)), }, ...__VLS_functionalComponentArgsRest(__VLS_66));
                            ({}({ ...{}, is: ((__VLS_ctx.Step3)), }));
                ...
                if (__VLS_ctx.forms.step1.type === 'MS SQL Server') {
                    {
                        ...
                        ({}({ ...{}, class: (" all900"), }));
                        {
                            ...
                            const __VLS_77 = __VLS_76({ ...{}, class: (" arch q-mt-sm"), style: ({}), }, ...__VLS_functionalComponentArgsRest(__VLS_76));
                            ({}({ ...{}, class: (" arch q-mt-sm"), style: ({}), }));
                            {
                                const __VLS_80 = (__VLS_ctx.Step25);
                                const __VLS_81 = __VLS_asFunctionalComponent(__VLS_80, new __VLS_80({ ...{}, is: ((__VLS_ctx.Step25)), }));
                                const __VLS_82 = __VLS_81({ ...{}, is: ((__VLS_ctx.Step25)), }, ...__VLS_functionalComponentArgsRest(__VLS_81));
                                ({}({ ...{}, is: ((__VLS_ctx.Step25)), }));
                    ...
                    // @ts-ignore
                    [step, live, step, live, step, live, stepper, step, step, step, Step1, Step1, Step1, Step1, st1, step, step, step, Step2, Step2, Step2, Step2, step, step, step, Step3, Step3, Step3, Step3, forms, Step25, Step25, Step25, Step25,];
                }
            ...
            }
            {
                ...
                const __VLS_86 = __VLS_asFunctionalComponent(__VLS_85, new __VLS_85({ ...{}, name: ((4)), prefix: ("4"), title: ("Конфигурация"), done: ((__VLS_ctx.step > 4)), }));
                ({}.QStep);
                const __VLS_87 = __VLS_86({ ...{}, name: ((4)), prefix: ("4"), title: ("Конфигурация"), done: ((__VLS_ctx.step > 4)), }, ...__VLS_functionalComponentArgsRest(__VLS_86));
                ({}({ ...{}, name: ((4)), prefix: ("4"), title: ("Конфигурация"), done: ((__VLS_ctx.step > 4)), }));
                {
                    ...
                    ({}({ ...{}, class: (" all900"), }));
                    {
                        ...
                        ({}({ ...{}, class: (" arch"), }));
                        {
                            const __VLS_100 = (__VLS_ctx.Step4);
                            const __VLS_101 = __VLS_asFunctionalComponent(__VLS_100, new __VLS_100({ ...{}, is: ((__VLS_ctx.Step4)), }));
                            const __VLS_102 = __VLS_101({ ...{}, is: ((__VLS_ctx.Step4)), }, ...__VLS_functionalComponentArgsRest(__VLS_101));
                            ({}({ ...{}, is: ((__VLS_ctx.Step4)), }));
            ...
            {
                const __VLS_105 = {}.QStep;
                const __VLS_106 = __VLS_asFunctionalComponent(__VLS_105, new __VLS_105({ ...{}, name: ((5)), prefix: ("5"), title: ("Подтверждение параметров БД"), done: ((__VLS_ctx.step > 5)), }));
                ({}.QStep);
                const __VLS_107 = __VLS_106({ ...{}, name: ((5)), prefix: ("5"), title: ("Подтверждение параметров БД"), done: ((__VLS_ctx.step > 5)), }, ...__VLS_functionalComponentArgsRest(__VLS_106));
                ({}({ ...{}, name: ((5)), prefix: ("5"), title: ("Подтверждение параметров БД"), done: ((__VLS_ctx.step > 5)), }));
                {
                    const __VLS_110 = __VLS_intrinsicElements["div"];
                    const __VLS_111 = __VLS_elementAsFunctionalComponent(__VLS_110);
                    const __VLS_112 = __VLS_111({ ...{}, class: (" all900"), }, ...__VLS_functionalComponentArgsRest(__VLS_111));
                    ({}({ ...{}, class: (" all900"), }));
                    {
                        const __VLS_115 = __VLS_intrinsicElements["div"];
                        const __VLS_116 = __VLS_elementAsFunctionalComponent(__VLS_115);
                        const __VLS_117 = __VLS_116({ ...{}, class: (" arch"), }, ...__VLS_functionalComponentArgsRest(__VLS_116));
                        ({}({ ...{}, class: (" arch"), }));
                        {
                            const __VLS_120 = (__VLS_ctx.Step5);
                            const __VLS_121 = __VLS_asFunctionalComponent(__VLS_120, new __VLS_120({ ...{}, is: ((__VLS_ctx.Step5)), }));
                            const __VLS_122 = __VLS_121({ ...{}, is: ((__VLS_ctx.Step5)), }, ...__VLS_functionalComponentArgsRest(__VLS_121));
                            ({}({ ...{}, is: ((__VLS_ctx.Step5)), }));
                ...
                }
                {
                    ...
                    ({}({ ...{}, class: (" all900"), }));
                    {
                        ...
                        const __VLS_132 = __VLS_131({ ...{}, class: (" arch q-mt-sm"), }, ...__VLS_functionalComponentArgsRest(__VLS_131));
                        ({}({ ...{}, class: (" arch q-mt-sm"), }));
                        {
                            const __VLS_135 = (__VLS_ctx.Step26);
                            const __VLS_136 = __VLS_asFunctionalComponent(__VLS_135, new __VLS_135({ ...{}, is: ((__VLS_ctx.Step26)), color: ("orange"), text: ("Создание базы данных может занять длительное время."), }));
                            const __VLS_137 = __VLS_136({ ...{}, is: ((__VLS_ctx.Step26)), color: ("orange"), text: ("Создание базы данных может занять длительное время."), }, ...__VLS_functionalComponentArgsRest(__VLS_136));
                            ({}({ ...{}, is: ((__VLS_ctx.Step26)), color: ("orange"), text: ("Создание базы данных может занять длительное время."), }));
            ...
            {
                const __VLS_140 = {}.QStep;
                const __VLS_141 = __VLS_asFunctionalComponent(__VLS_140, new __VLS_140({ ...{}, name: ((6)), prefix: ("6"), title: ("Создание БД"), done: ((__VLS_ctx.step > 6)), }));
                ({}.QStep);
                const __VLS_142 = __VLS_141({ ...{}, name: ((6)), prefix: ("6"), title: ("Создание БД"), done: ((__VLS_ctx.step > 6)), }, ...__VLS_functionalComponentArgsRest(__VLS_141));
                ({}({ ...{}, name: ((6)), prefix: ("6"), title: ("Создание БД"), done: ((__VLS_ctx.step > 6)), }));
                {
                    const __VLS_145 = __VLS_intrinsicElements["div"];
                    const __VLS_146 = __VLS_elementAsFunctionalComponent(__VLS_145);
                    const __VLS_147 = __VLS_146({ ...{}, class: (" all900"), }, ...__VLS_functionalComponentArgsRest(__VLS_146));
                    ({}({ ...{}, class: (" all900"), }));
                    {
                        const __VLS_150 = __VLS_intrinsicElements["div"];
                        const __VLS_151 = __VLS_elementAsFunctionalComponent(__VLS_150);
                        const __VLS_152 = __VLS_151({ ...{}, class: (" arch"), }, ...__VLS_functionalComponentArgsRest(__VLS_151));
                        ({}({ ...{}, class: (" arch"), }));
                        {
                            const __VLS_155 = (__VLS_ctx.Step7);
                            const __VLS_156 = __VLS_asFunctionalComponent(__VLS_155, new __VLS_155({ ...{}, is: ((__VLS_ctx.Step7)), result: ("База данных создана успешно!"), }));
                            const __VLS_157 = __VLS_156({ ...{}, is: ((__VLS_ctx.Step7)), result: ("База данных создана успешно!"), }, ...__VLS_functionalComponentArgsRest(__VLS_156));
                            ({}({ ...{}, is: ((__VLS_ctx.Step7)), result: ("База данных создана успешно!"), }));
                ...
                if (__VLS_ctx.wiz.done) {
                    {
                        ...
                        ({}({ ...{}, class: (" all900"), }));
                        {
                            ...
                            const __VLS_167 = __VLS_166({ ...{}, class: (" arch q-mt-sm"), }, ...__VLS_functionalComponentArgsRest(__VLS_166));
                            ({}({ ...{}, class: (" arch q-mt-sm"), }));
                            {
                                const __VLS_170 = (__VLS_ctx.Step6);
                                const __VLS_171 = __VLS_asFunctionalComponent(__VLS_170, new __VLS_170({ ...{}, is: ((__VLS_ctx.Step6)), }));
                                const __VLS_172 = __VLS_171({ ...{}, is: ((__VLS_ctx.Step6)), }, ...__VLS_functionalComponentArgsRest(__VLS_171));
                                ({}({ ...{}, is: ((__VLS_ctx.Step6)), }));
                    ...
                    // @ts-ignore
                    [step, step, step, Step4, Step4, Step4, Step4, step, step, step, Step5, Step5, Step5, Step5, Step26, Step26, Step26, Step26, step, step, step, Step7, Step7, Step7, Step7, wiz, Step6, Step6, Step6, Step6,];
                }
                (__VLS_143.slots).default;
                const __VLS_143 = __VLS_pickFunctionalComponentCtx(__VLS_140, __VLS_142);
            }
            {
                const __VLS_175 = {}.QStep;
                const __VLS_176 = __VLS_asFunctionalComponent(__VLS_175, new __VLS_175({ ...{}, name: ((7)), prefix: ("7"), title: ("Завершение"), done: ((__VLS_ctx.step > 7)), }));
                ({}.QStep);
                const __VLS_177 = __VLS_176({ ...{}, name: ((7)), prefix: ("7"), title: ("Завершение"), done: ((__VLS_ctx.step > 7)), }, ...__VLS_functionalComponentArgsRest(__VLS_176));
                ...
                if (__VLS_ctx.wiz.dopModules) {
                    {
                        ...
                        const __VLS_182 = __VLS_181({ ...{}, class: (" all900"), }, ...__VLS_functionalComponentArgsRest(__VLS_181));
                        ({}({ ...{}, class: (" all900"), }));
                        {
                            const __VLS_185 = __VLS_intrinsicElements["div"];
                            const __VLS_186 = __VLS_elementAsFunctionalComponent(__VLS_185);
                            const __VLS_187 = __VLS_186({ ...{}, class: (" arch"), }, ...__VLS_functionalComponentArgsRest(__VLS_186));
                            ({}({ ...{}, class: (" arch"), }));
                            {
                                const __VLS_190 = (__VLS_ctx.Step7);
                                const __VLS_191 = __VLS_asFunctionalComponent(__VLS_190, new __VLS_190({ ...{}, is: ((__VLS_ctx.Step7)), hint: ("Установка доп.модулей"), result: ("Модули установлены!"), }));
                                const __VLS_192 = __VLS_191({ ...{}, is: ((__VLS_ctx.Step7)), hint: ("Установка доп.модулей"), result: ("Модули установлены!"), }, ...__VLS_functionalComponentArgsRest(__VLS_191));
                ...
                if (__VLS_ctx.wiz.finish > 1) {
                    {
                        ...
                        const __VLS_197 = __VLS_196({ ...{}, class: (" all900"), }, ...__VLS_functionalComponentArgsRest(__VLS_196));
                        ({}({ ...{}, class: (" all900"), }));
                        {
                            const __VLS_200 = __VLS_intrinsicElements["div"];
                            const __VLS_201 = __VLS_elementAsFunctionalComponent(__VLS_200);
                            const __VLS_202 = __VLS_201({ ...{}, class: (" arch q-mt-sm"), }, ...__VLS_functionalComponentArgsRest(__VLS_201));
                            ({}({ ...{}, class: (" arch q-mt-sm"), }));
                            {
                                const __VLS_205 = (__VLS_ctx.Finish);
                                const __VLS_206 = __VLS_asFunctionalComponent(__VLS_205, new __VLS_205({ ...{}, is: ((__VLS_ctx.Finish)), }));
                                const __VLS_207 = __VLS_206({ ...{}, is: ((__VLS_ctx.Finish)), }, ...__VLS_functionalComponentArgsRest(__VLS_206));
                                ({}({ ...{}, is: ((__VLS_ctx.Finish)), }));
...
//# sourceMappingURL=CreateDatabase.vue.js.map