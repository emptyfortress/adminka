    ...
    }
    {
        ...
        ({}({ ...{}, class: (" grid"), }));
        {
            ...
            ({}({ ...{}, class: (" left wh"), }));
            {
                ...
                const __VLS_22 = __VLS_asFunctionalComponent(__VLS_21, new __VLS_21({ ...{}, flat: (true), columns: ((__VLS_ctx.config.columns)), rows: ((__VLS_ctx.filteredRows)), rowKey: ("id"), hideBottom: (true), pagination: ((__VLS_ctx.pagination)), color: ("primary"), }));
                ({}.QTable);
                const __VLS_23 = __VLS_22({ ...{}, flat: (true), columns: ((__VLS_ctx.config.columns)), rows: ((__VLS_ctx.filteredRows)), rowKey: ("id"), hideBottom: (true), pagination: ((__VLS_ctx.pagination)), color: ("primary"), }, ...__VLS_functionalComponentArgsRest(__VLS_22));
                ({}({ ...{}, flat: (true), columns: ((__VLS_ctx.config.columns)), rows: ((__VLS_ctx.filteredRows)), rowKey: ("id"), hideBottom: (true), pagination: ((__VLS_ctx.pagination)), color: ("primary"), }));
                {
                    ...
                    ({}({ ...{}, }));
                    {
                        const [props] = __VLS_getSlotParams((__VLS_24.slots).body);
                        {
                            ...
                            {
                                const __VLS_41 = {}.QTd;
                                const __VLS_42 = __VLS_asFunctionalComponent(__VLS_41, new __VLS_41({ ...{}, props: ((props)), key: ("module"), }));
                                ({}.QTd);
                                const __VLS_43 = __VLS_42({ ...{}, props: ((props)), key: ("module"), }, ...__VLS_functionalComponentArgsRest(__VLS_42));
...
//# sourceMappingURL=ConfigPanel0.vue.js.map