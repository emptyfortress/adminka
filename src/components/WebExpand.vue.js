...
function __VLS_template() {
    ...
    [QTooltip,];
    {
        ...
        for (const [panel, index] of __VLS_getVForSourceType((__VLS_ctx.store.panelsWeb))) {
            {
                ...
                }
                {
                    ...
                    ({}({ ...{}, class: (" pcard"), }));
                    {
                        ...
                        const __VLS_62 = __VLS_asFunctionalComponent(__VLS_61, new __VLS_61({ ...{ 'onChange': {}, 'onHaserror': {}, 'onNoerror': {}, }, is: ((__VLS_ctx.calcComponent(panel.id))), key: ((__VLS_ctx.key)), first: (true), }));
                        const __VLS_63 = __VLS_62({ ...{ 'onChange': {}, 'onHaserror': {}, 'onNoerror': {}, }, is: ((__VLS_ctx.calcComponent(panel.id))), key: ((__VLS_ctx.key)), first: (true), }, ...__VLS_functionalComponentArgsRest(__VLS_62));
                        ({}({ ...{ 'onChange': {}, 'onHaserror': {}, 'onNoerror': {}, }, is: ((__VLS_ctx.calcComponent(panel.id))), key: ((__VLS_ctx.key)), first: (true), }));
...
//# sourceMappingURL=WebExpand.vue.js.map