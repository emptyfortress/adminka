...
function __VLS_template() {
    ...
    }
    {
        ...
        ({}({ ...{}, class: (" grid"), }));
        {
            ...
            ({}({ ...{}, class: (" left wh"), }));
            {
                ...
                const __VLS_22 = __VLS_asFunctionalComponent(__VLS_21, new __VLS_21({ ...{}, flat: (true), columns: ((__VLS_ctx.config.columns1)), rows: ((__VLS_ctx.filteredRows)), rowKey: ("id"), hideBottom: (true), pagination: ((__VLS_ctx.pagination)), color: ("primary"), }));
                ({}.QTable);
                const __VLS_23 = __VLS_22({ ...{}, flat: (true), columns: ((__VLS_ctx.config.columns1)), rows: ((__VLS_ctx.filteredRows)), rowKey: ("id"), hideBottom: (true), pagination: ((__VLS_ctx.pagination)), color: ("primary"), }, ...__VLS_functionalComponentArgsRest(__VLS_22));
                ({}({ ...{}, flat: (true), columns: ((__VLS_ctx.config.columns1)), rows: ((__VLS_ctx.filteredRows)), rowKey: ("id"), hideBottom: (true), pagination: ((__VLS_ctx.pagination)), color: ("primary"), }));
                {
                    ...
                    ({}({ ...{}, }));
                    {
                        const [props] = __VLS_getSlotParams((__VLS_24.slots).body);
                        {
                            ...
                            __VLS_35 = { click: $event => {
                                    __VLS_ctx.config.selectRow1(props.row);
                                    // @ts-ignore
                            ...
                            {
                                const __VLS_36 = {}.QTd;
                                const __VLS_37 = __VLS_asFunctionalComponent(__VLS_36, new __VLS_36({ ...{}, props: ((props)), key: ("name"), }));
                                ({}.QTd);
                                const __VLS_38 = __VLS_37({ ...{}, props: ((props)), key: ("name"), }, ...__VLS_functionalComponentArgsRest(__VLS_37));
                                ({}({ ...{}, props: ((props)), key: ("name"), }));
                                {
                                    const __VLS_41 = __VLS_intrinsicElements["span"];
                                    const __VLS_42 = __VLS_elementAsFunctionalComponent(__VLS_41);
                                    const __VLS_43 = __VLS_42({ ...{}, class: ((__VLS_ctx.calcClass(props.row))), }, ...__VLS_functionalComponentArgsRest(__VLS_42));
                                    ({}({ ...{}, class: ((__VLS_ctx.calcClass(props.row))), }));
                                    __VLS_styleScopedClasses = (calcClass(props.row));
                                    if (props.row.config.length) {
                                        {
                                            const __VLS_46 = {}.QTooltip;
                                            const __VLS_47 = __VLS_asFunctionalComponent(__VLS_46, new __VLS_46({ ...{}, class: (" bg-secondary"), }));
                                            ({}.QTooltip);
                                            const __VLS_48 = __VLS_47({ ...{}, class: (" bg-secondary"), }, ...__VLS_functionalComponentArgsRest(__VLS_47));
                                            ({}({ ...{}, class: (" bg-secondary"), }));
                                    ...
                                    else {
                                        {
                                            ...
                                            const __VLS_52 = __VLS_asFunctionalComponent(__VLS_51, new __VLS_51({ ...{}, class: (" bg-red"), }));
                                            ({}.QTooltip);
                                            const __VLS_53 = __VLS_52({ ...{}, class: (" bg-red"), }, ...__VLS_functionalComponentArgsRest(__VLS_52));
                                            ({}({ ...{}, class: (" bg-red"), }));
                            ...
                            {
                                const __VLS_61 = {}.QTd;
                                const __VLS_62 = __VLS_asFunctionalComponent(__VLS_61, new __VLS_61({ ...{}, props: ((props)), key: ("os"), }));
                                ({}.QTd);
                                const __VLS_63 = __VLS_62({ ...{}, props: ((props)), key: ("os"), }, ...__VLS_functionalComponentArgsRest(__VLS_62));
                                ({}({ ...{}, props: ((props)), key: ("os"), }));
                                (props.row.os);
        ...
        }
        {
            ...
            const __VLS_68 = __VLS_67({ ...{}, class: (" to"), }, ...__VLS_functionalComponentArgsRest(__VLS_67));
            ({}({ ...{}, class: (" to"), }));
            {
                const __VLS_71 = {}.QIcon;
                const __VLS_72 = __VLS_asFunctionalComponent(__VLS_71, new __VLS_71({ ...{}, name: ("mdi-arrow-right-bold"), size: ("lg"), }));
                ({}.QIcon);
                const __VLS_73 = __VLS_72({ ...{}, name: ("mdi-arrow-right-bold"), size: ("lg"), }, ...__VLS_functionalComponentArgsRest(__VLS_72));
        ...
        }
        {
            ...
            const __VLS_78 = __VLS_77({ ...{}, class: (" right wh"), }, ...__VLS_functionalComponentArgsRest(__VLS_77));
            ({}({ ...{}, class: (" right wh"), }));
            {
                const __VLS_81 = {}.QTable;
                const __VLS_82 = __VLS_asFunctionalComponent(__VLS_81, new __VLS_81({ ...{}, flat: (true), columns: ((__VLS_ctx.config.columns2)), rows: ((__VLS_ctx.compRows1)), hidePagination: (true), noDataLabel: ("Конфигурации не обнаружены."), }));
                ({}.QTable);
                const __VLS_83 = __VLS_82({ ...{}, flat: (true), columns: ((__VLS_ctx.config.columns2)), rows: ((__VLS_ctx.compRows1)), hidePagination: (true), noDataLabel: ("Конфигурации не обнаружены."), }, ...__VLS_functionalComponentArgsRest(__VLS_82));
                ({}({ ...{}, flat: (true), columns: ((__VLS_ctx.config.columns2)), rows: ((__VLS_ctx.compRows1)), hidePagination: (true), noDataLabel: ("Конфигурации не обнаружены."), }));
    ...
    var __VLS_slots;
    // @ts-ignore
    [config, compRows1, config, compRows1, config, compRows1,];
    return __VLS_slots;
}
...
//# sourceMappingURL=ConfigPanel1.vue.js.map