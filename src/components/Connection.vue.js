        ...
        }
        {
            ...
            ({}({ ...{}, class: (" card"), }));
            {
                ...
                }
                {
                    ...
                    ({}({ ...{}, color: ("warning"), }));
                    (__VLS_ctx.store.connections.length);
            ...
            for (const [item] of __VLS_getVForSourceType((__VLS_ctx.store.connections))) {
                {
                    const __VLS_41 = (__VLS_ctx.GreyBlock1);
                    const __VLS_42 = __VLS_asFunctionalComponent(__VLS_41, new __VLS_41({ ...{ 'onDelete': {}, 'onDuble': {}, }, is: ((__VLS_ctx.GreyBlock1)), key: ((item.name)), name: ((item.name)), }));
                    const __VLS_43 = __VLS_42({ ...{ 'onDelete': {}, 'onDuble': {}, }, is: ((__VLS_ctx.GreyBlock1)), key: ((item.name)), name: ((item.name)), }, ...__VLS_functionalComponentArgsRest(__VLS_42));
                    ({}({ ...{ 'onDelete': {}, 'onDuble': {}, }, is: ((__VLS_ctx.GreyBlock1)), key: ((item.name)), name: ((item.name)), }));
                    let __VLS_46 = { 'delete': __VLS_pickEvent(__VLS_45['delete'], {}.onDelete) };
                    __VLS_46 = { delete: $event => {
                            __VLS_ctx.store.deleteConnection(item);
                            // @ts-ignore
                            [type, type, type, store, add, store, GreyBlock1, GreyBlock1, GreyBlock1, GreyBlock1, store,];
                        }
                    };
...
//# sourceMappingURL=Connection.vue.js.map